    ...
    int bandera = 0;
        ...
        if(this != NULL && this2 != NULL)
        {
                for(i=0;i < this2->size ;i++)
                {
                    ...
                    {
                        if(al_contains(*(this->pElements+j),*(this2->pElements+i)) == 0)
                        {
                            bandera = 1;
                        }
...
int expand(ArrayList* this,int index)
{
    ...
    void* auxiliar;
        ...
        if(this != NULL)
        {
            if(index >= 0 && index < this->size)
            {
                auxiliar = (void*) realloc(*(this->pElements+index),sizeof(void*)*(this->reservedSize*AL_INCREMENT));

                if(auxiliar != NULL)
                {
                    *(this->pElements+index) = auxiliar;
                    this->reservedSize += AL_INCREMENT;
                    returnAux = 0;
                }
            }
...
int resizeDown(ArrayList* this)
{
    ...
    void* auxiliar;
        ...
        if(this != NULL)
        {
            ...
            auxiliar = (void*) realloc(this->pElements,sizeof(void*)*(this->size-AL_INCREMENT));
